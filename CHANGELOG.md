...
### Features
-  Add guidance documents for Antigravity and Claude agents, and update the release workflow to use pull requests for version bumps. (e534c18)
-  add changelog generation and update script for version entries (84cbe9c)
-  update onboarding components to use adaptive dark/light theme colors (071ab8b)
-  update Xcode version in CI and release workflows, enhance MainActor usage in various classes (9b31c08)
-  enhance CI and release workflows with improved error handling and environment variable checks (39f3205)
-  enhance sponsor section layout and add color attributes to sponsor links (fa9e74d)
-  update star history section in README for improved link and image sources (e97c2fc)
-  update license information from MIT to BSD 3-Clause License in README (ac1cac2)
-  update documentation for build instructions and licensing flow (7b43714)
-  update macOS requirement from 14.0+ to 13.0+ in documentation (4ec5661)
-  add CODE_OF_CONDUCT.md and CONTRIBUTING.md files to establish community guidelines and contribution process (f2d3c69)
-  add BSD 3-Clause License file to the repository (48f5ce2)
-  remove outdated AGENTS.md and CLAUDE.md files; add project build and release workflow documentation (049f54b)
-  Implement auto-focus functionality with mouse tracking (#1) (970e6dd)
...
### Chore
- refactor: remove unnecessary coordinate conversion logic in screen capture process (233c2c2)
- chore: remove setup of Secrets.xcconfig from CI and release workflows (1d38ab2)
- chore: adding sponsor info (e4de0ca)
